...
export const translations = {
    ...
    en: {
        ...
        messages: {
           ...
           WRITE_LIMIT_EXCEEDED: `Rate limit exceeded: only ${config.MAX_DAILY_WRITES} write request${config.MAX_DAILY_WRITES > 1 ? 's' : ''} allowed per day.`,
            ...
            ROOT_URL_MESSAGE: "Welcome to the API root. For documentation and usage details, visit: https://github.com/Nde-Code/nde-shortener.",
    ...
    fr: {
        ...
        messages: {
            ...
            ROOT_URL_MESSAGE: "Bienvenue à la racine de l'API. Consultez: https://github.com/Nde-Code/nde-shortener pour plus d'informations.",
